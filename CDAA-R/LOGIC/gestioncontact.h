...
class GestionContact
{
    ...
    public:
        GestionContact();
        void AddContact(std::string nom, std::string prenom, std::string entreprise, std::string mail, std::string telephone, QImage photo, Horodatage horodatage = Horodatage());
