...
echo.
echo Signe le .msix
"C:\Program Files (x86)\Windows Kits\10\bin\10.0.19041.0\x64\signtool.exe" sign /debug /fd sha256 /f "Groupe R without password.pfx" /t http://timestamp.digicert.com/ CDAA-R_UWP.msix
echo.
